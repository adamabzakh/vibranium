    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: VibraniumColors.outline, width: 1),
          boxShadow: const [
            BoxShadow(
        ...
        child: Row(
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Premium bites, signature drinks, and a polished Vibranium experience.',
                    style: theme.textTheme.bodyMedium?.copyWith(
                      color: VibraniumColors.white.withOpacity(0.92),
                      height: 1.4,
                    ),
                  ),
                ],
            ...
            Container(
              ...
              height: 64,
              decoration: BoxDecoration(
                color: VibraniumColors.white.withOpacity(0.12),
                shape: BoxShape.circle,
                border: Border.all(
                  color: VibraniumColors.white.withOpacity(0.18),
                ),
              ),
              child: const Icon(
